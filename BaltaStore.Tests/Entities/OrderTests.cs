...
namespace BaltaStore.Tests
{
    ...
    public class OrderTests
    {
        ...
        public OrderTests()
        {
            ...
            var name = new Name("Bruno", "Bomes");
            var document = new Document("46718115533");
            var email = new Email("hello@bruno.io");
            _customer = new Customer(name, document, email, "554399876542");
        ...
        // Dados mais 10 produtos, devem haver duas entregas
        [TestMethod]
        public void ShouldOneShippingWhenPurchasedFourProducts()
        {
            _order.AddItem(_mouse, 1);
            _order.AddItem(_mouse, 1);
            _order.AddItem(_mouse, 1);
            ...
            Assert.AreEqual(1, _order.Deliveries.Count);
        }
